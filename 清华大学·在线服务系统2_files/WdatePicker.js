...
var $dp, WdatePicker; (function() {
	...
	//添加鼠标滑轮监控事件，滚动滑轮关闭日历 任佳奇   注释by刘淼 此处性能有问题，先注释掉。
...
//		}catch(e){}
//	};  
//	var oDiv = document.getElementById('page-scroll-container');
//	addEvent(oDiv,'mousewheel',onMouseWheel);
//	addEvent(oDiv,'DOMMouseScroll',onMouseWheel);
//	function onMouseWheel() {
//	  var divdatapicker = document.getElementById('wdatapicker');
//	  try{
//		  divdatapicker.style.display="none";  
//	  }catch(e){}
//	};
	//添加鼠标滑轮监控事件，滚动滑轮关闭日历 任佳奇
})()