var str_psychology = "\
	...
	<ul> \
		<li> Cerebrum contains two cerebral hemispheres, connected by dense corpus callosum (胼胝体) <br/> \
		Topographical map: two things that are close together in the body are similarly close together in brain (e.g., elbow & finger); the size of brain areas doesn't correspond to the size of the actual body areas </li> \
		<li> Four lobes (脑叶): occipital, temporal, parietal, frontal, responsible for different functions </li> \
	</ul> \
	<h4> Lateralization </h4> \
	<ul style='list-style-type:circle'> \
		<li> Most functions are replicated (sensory, motor) <br/> \
		Contralateral (opposite-side) control: the left (right) cerebral hemisphere is responsible for sensations and movements on the right (left) of the body </li> \
	...
	<ul> \
		<li class='multili'> [Birth - 4 months]: preference to melody of own language; sensitive to all phonemes </li> \
		<li class='multili'> [7 months]: babbling </li> \
		<li class='multili'> [12 months]: first word – objects/actions/properties; some sensitivity to word order </li> \
		<li class='multili'> [18 months]: learning words faster; multi-word sentences; functional phonemes (e.g., in, of, a, the) </li> \
		<li class='multili'> [Past puberty]: learning is more difficult </br> \
		Past age 3, the older you start learning language, the worse you are <br/> \
	...
	<ul> \
		...
		<li> Language may be essential for some unique human powers, but not for all abstract thoughts </br/> \
		Evidence: <br/> \
		-&emsp;  Even some nonverbal children can pass False Belief Task <br/> \
		-&emsp; Animals can understand 1+1=2 </li> \
	</ul> \
	<h2> Cognition </h2> \
	<h3> Perception </h3> \
	...
	<ul> \
		...
		<li> <a href='#_Divided_Attention_'>Divided attention</a>: the ability to flexibly allocate attentional resources between two or more concurrent tasks  </li> \
	...
	<ul style='list-style-type: circle'> \
		<li class='multili'> People can become pretty good at the shadowing task, and they can easily report the content of the message that they attend to </li> \
		<li class='multili'> People can also tell physical characteristics of the shadowed task (e.g., man/woman voice, pitch), but cannot tell the content (e.g., the switch of languages) </li> \
		<li class='multili'> Tasks for vision: two transparent &amp; overlapping videos </li> \
		<li class='multili'> <b>Inattention Blindness</b>: the failure to notice a fully visible object when attention is devoted to something else (e.g., miss car horn when driving while taking a phone call) </li> \
	</ul> \
	<h4> Models of Selection Attention </h4> \
	<ul> \
		<li> Broadbent’s Filter Model <br/> \
		People seemed vaguely aware of the physical features of the unattended information, but had no knowledge of the meaning <br/> \
		Selection occurs very early, with no additional processing for the unselected information </br/> \
		<img width='400px' src='note_files/psychology/selective_attention_0.png'/></li> \
		<li> Treisman’s Attenuation Model <br/> \
		People tend to hear meaningful information even when you aren’t paying attention to it, suggest that people do monitor the unattended information to some degree on the basis of its meaning <br/> \
		Selection starts at the physical or perceptual level, but that the unattended information is not blocked completely, it is just weakened or attenuated </br/> \
		<img width='400px' src='note_files/psychology/selective_attention_1.png'/></li> \
		<li> Late Selection Models <br/> \
		All information in the unattended ear is processed on the basis of meaning, not just the selected or highly pertinent information <br/> \
		Only the information that is relevant for the task response gets into conscious awareness <br/> \
		<b>Subliminal perception</b>: stimuli presented below the threshold for awareness can influence thoughts, feelings, or actions <br/> \
		<img width='400px' src='note_files/psychology/selective_attention_2.png'/></li> \
		<li> Multimode Model </br/> \
		The stage at which selection occurs can change depending on the task <br/> \
		People have the flexibility to change how they deploy their attention depending upon what they are trying to accomplish </li> \
	</ul> \
	<h3> Divided Attention </h3> \
	<p> The ability to flexibly allocate attentional resources between two or more concurrent tasks </p> \
	<h4> Divided Attention Task </h4> \
	<p> People are trained to take dictation for spoken words while reading unrelated material for comprehension </p> \
	<ul> \
		<li class='multili'> A decrease in performance for either task <br/> \
		Even if attention can be divided or switched between the tasks, the cognitive demands are too great to avoid disruption of performance </li> \
		<li class='multili'> People have no fixed limits on attentional capacity after plenty of practice <br/> \
		Changing the tasks somewhat (e.g., reading aloud rather than silently), impair performance initially </li> \
	...
	<ul> \
		<li class='multili'> <b>Id</b> (本我): present at birth, instinctual, animalistic, does not distinguish fantasy from reality, operates according to the pleasure principle (e.g., eat, drink, poop, pee, get warm, get sexual pleasure) </li> \
		<li class='multili'> <b>Ego</b> (自我): develop out of the id in infancy, understand reality and logic, mediator between id and superego, i.e., conscious (e.g., pragmatically satisfy or repress desires) itself </li> \
		<li class='multili'> <b>Superego</b> (超我): internalization of society's moral standards, responsible for guilt (e.g., not to cheat) </li> \
	</ul> \
	...
	<ul> \
		<li class='multili'> Oral stage (口唇期) [birth - 1 year]: the mouth is associated with pleasure <br/> \
		Weaning a child incorrectly can lead to fixation <br/> \
		An adult will eat too much, chew gum, smoke, or be pessimistic, dependent, needy <br/> </li> \
		<li class='multili'> Anal stage (肛门期) [1 – 3 years]: the anus is associated with pleasure <br/> \
		Incorrect toilet training can lead to fixation <br/> \
		An adult will be compulsive, stubborn, clean, stingy, unwilling to part with his own feces </li> \
		<li class='multili'> Phallic stage (生殖器期) [3 - 5 years]: the focus of pleasure shifts to the genitals (生殖器) <br/> \
		A boy (girl) looks for sexual object to have contact with, the candidate will be mother (father), and he (she) wants to compete with / kill his father (her mother) <br/> \
		An adult will have excessive masculinity (大男子主义), Oedipus complex (恋母情结), a need for attention, or domination in females </li> \
		<li class='multili'> Latency stage (潜伏期) [5 years – puberty (青春期)]: sexuality is repressed <br/> \
		Children participate in hobbies, school, friendship; boys and girls do activities separately </li> \
		<li class='multili'> Genital stage (生殖期) [puberty on]: sexual feelings re-emerge and are oriented toward others <br/> \
		Healthy adults find pleasure in love and work <br/> \
		Fixated adults have their energy tied up in earlier stages, struggle with problems; if they are lucky, resolve and develop </li> \
	</ul> \
	...
	<table class='explicit' cellpadding='5px'> \
	...
	<ul style='list-style-type: circle'> \
		<li> Reinforced trials: conditioned stimulus & unconditioned stimulus come together; increase the connection <br/> \
		Unreinforced trials: conditioned stimulus comes without unconditioned stimulus; decrease the connection </li> \
	...
	<ul> \
		<li class='multili'> Positive reinforcement: reward <br/> \
		Negative reinforcement: release from something aversive <br/> \
		Positive punishment </li> \
		<li class='multili'> Law of Effect (Edward Thorndike's theory): an animal does different activities, gradually comes to the correct behavior in certain situation <br/> \
		The tendency to perform an action is increased if rewarded, weakened if not </li> \
		<li class='multili'> Shaping: not wait for an action and reward it, but reward a roughly approximate action to lead the direction <br/> \
		Reward step by step </li> \
		<li class='multili'> Classical conditioning + operant conditioning (e.g., give a dog food & pat its head, later patting its head can be a reward) </li> \
		<li  class='multili' style='color:#ff0000'> If you reward someone every time, when stop, the behavior will go away quickly <br/> \
		To make a behavior last long, reinforce partially & intermittently (fixed/variable ratio/interval schedule) </li> \
	</ul> \
	...
	<ul> \
		...
		<li> Knowledge: how much people are born with / people have to learn? <br/> \
		<ul> \
	...
	<ul> \
		<li class='multili'> Sensorimotor stage (感觉动作期) [0-2 years]: information is gained through the senses and motor actions; the child perceives and manipulates but does not reason </li> \
		<li class='multili'> Preoperational stage (前运算思维期) [2-7 years]: emergence of symbolic thought (e.g., object permanence); can reason but not in a higher order way (egocentric); lack the concept of conservation </li> \
		<li class='multili'> Concrete Operational stage (具体运算思维期) [7-12 years]: increase logical thoughts (understanding conservation); less egocentric; inability to reason fully abstractly or hypothetically </li> \
		<li class='multili'> Formal Operational stage (形式运算思维期) [12 years - adult]: abstract and scientific reasoning </li> \
	</ul> \
	...
	<ul> \
		<li class='multili'> Observe the behavior that baby sucks a pacifier <br/> \
		Compare two sucking behaviors (enjoy or not enjoy) under two conditions </li> \
		<li class='multili'> Study the minds of babies by their looking <br/> \
		Babies show surprise with something violates their expectation (longer stare time) <br/> \
		Babies get bored quickly with something that is the same as their expectation (look away) </li> \
		<li class='multili'> Show two things and let the baby choose </li> \
	</ul> \
	...
	-&emsp; Adults: basket, that's where she put the marble <br/> \
	-&emsp; Children: box, that's where the marble is <br/> \
	<h3> Explanation for Development </h3> \
	<ul> \
		<li class='multili'> Brain is not fully developed <br/> \
		Neuron interconnections are large early, then prune when developing <br/> \
		Modernization: the myelin sheath around neurons that makes them run faster and more effectively </li> \
		<li class='multili'> Brain contains specific modules (with their own developmental trajectory) <br/> \
		Different modules (e.g., for the physical world, for the social world, for the reasoning) have different innate knowledge, and their development is constrained in special way </li> \
	</ul> \
";